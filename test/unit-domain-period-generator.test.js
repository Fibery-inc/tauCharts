...
describe("Unit domain period generator", function () {
  ...
  it("should generate empty array for unknown period", function () {
    var r = PeriodGenerator.generate(iso("2014-10-30T23:59:59"), iso("2014-11-02T10:00:00"), "some_unknown_period");

    expect(r.length).to.equal(0);
  });

  it("should generate [day] range", function () {
    var r = PeriodGenerator.generate(iso("2014-10-30T23:59:59"), iso("2014-11-02T10:00:00"), "day");
  ...
  it("should generate [week] range (by sundays)", function () {
    var r = PeriodGenerator.generate(iso("2014-10-30T23:59:59"), iso("2014-11-02T10:00:00"), "week");
  ...
  it("should generate [month] range", function () {
    var r = PeriodGenerator.generate(iso("2014-10-30T23:59:59"), iso("2014-11-02T10:00:00"), "month");
  ...
  it("should generate [quarter] range", function () {
    var r = PeriodGenerator.generate(iso("2014-10-30T23:59:59"), iso("2015-04-02T10:00:00"), "quarter");
  ...
  it("should generate [year] range", function () {
    var r = PeriodGenerator.generate(iso("1998-10-30T23:59:59"), iso("2002-11-02T10:00:00"), "year");
...
describe("UTC unit domain period generator", function () {
  ...
  it("should generate empty array for unknown UTC period", function () {
    var r = PeriodGenerator.generate(utc("2014-10-30T23:59:59"), utc("2014-11-02T10:00:00"), "some_unknown_period", {
      utc: true,
    });
  ...
  it("should generate [UTC day] range", function () {
    var r = PeriodGenerator.generate(utc("2014-10-30T23:59:59"), utc("2014-11-02T10:00:00"), "day", { utc: true });
  ...
  it("should generate [UTC week] range (by sundays)", function () {
    var r = PeriodGenerator.generate(utc("2014-10-30T23:59:59"), utc("2014-11-02T10:00:00"), "week", { utc: true });
  ...
  it("should generate [UTC month] range", function () {
    var r = PeriodGenerator.generate(utc("2014-10-30T23:59:59"), utc("2014-11-02T10:00:00"), "month", { utc: true });
  ...
  it("should generate [UTC quarter] range", function () {
    var r = PeriodGenerator.generate(utc("2014-10-30T23:59:59"), utc("2015-04-02T10:00:00"), "quarter", { utc: true });
  ...
  it("should generate [UTC year] range", function () {
    var r = PeriodGenerator.generate(utc("1998-10-30T23:59:59"), utc("2002-11-02T10:00:00"), "year", { utc: true });
