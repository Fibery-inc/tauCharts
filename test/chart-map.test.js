...
describe("Map chart", function () {
  ...
  it("should draw by code", function (done) {
    ...
    var contourNode = d3.select(target).select(".map-contour-countries").node();
    ...
    var highlightedContours0 = d3.select(target).selectAll(".map-contour-highlighted");
    ...
    var highlightedContours1 = d3.select(target).selectAll(".map-contour-highlighted");
  ...
  it("should draw by code and lat-lon", function (done) {
    ...
    var pointNode = d3.select(target).select("circle").node();
    ...
    var highlightedPoints0 = d3.select(target).selectAll(".map-point-highlighted");
    ...
    var highlightedPoints1 = d3.select(target).selectAll(".map-point-highlighted");
    ...
    var highlightedPoints2 = d3.select(target).selectAll(".map-point-highlighted");
    ...
    var highlightedPoints3 = d3.select(target).selectAll(".map-point-highlighted");
  ...
  it("should draw UK map with places", function (done) {
    ...
    var chart2 = new tauChart.Chart({
      ...
      longitude: "x",
      size: "size",
      data: [{ x: 0.5, y: 51.32, color: "green", size: 2 }],
      guide: {
        sourcemap: theUKMap,
      },
      settings: settings,
