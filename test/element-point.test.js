...
describePlot(
  "Point element without color and size params",
  {
    unit: {
      type: "COORDS.RECT",
      x: "x",
...
describePlot(
  ...
  testData.concat(
    ...
    { x: 4, y: 4, color: "unknown", size: 8 },
    { x: 5, y: 6, color: "unknowns", size: 8 }
  ),
  function () {
    it("should render point with right color", function () {
      var dots = getDots();
