...
describe("LayerLabelsRules", function () {
  ...
  beforeEach(function () {
    ...
    seedModel = LayerLabelsModel.seed(gogModel, {
      fontColor: "#000",
      flip: false,
  ...
  it("should support [cut-label-horizontal] rule (by width)", function () {
    ...
    expect(m.w(row10)).to.equal(
      m.model.y0(row10) - m.model.yi(row10),
      "cut text width by available space (from 20 original)"
    );
  });
  ...
  it("should support [rotate-on-size-overflow] rule", function () {
    ...
    var rows = [{ text: "123" }, { text: "3214" }, { text: "1" }];
  ...
  it("should support [cut-label-vertical] with [rotate-on-size-overflow] rule", function () {
    ...
    var rows = [{ text: "123" }, { text: "1234567890" }, { text: "1" }];
  ...
  it("should support [multiline-label-vertical-center-align] rule", function () {
    ...
    var m = createModel(["multiline-label-vertical-center-align"], seedModel, {
      data: rows,
      maxWidth: 5,
      maxHeight: 5,
    });
