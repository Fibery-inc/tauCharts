...
declare var api: {
  ...
  plugins: {
    ...
    get(name: "bar-as-span"): (settings: { x0?: string; y0?: string; collapse?: boolean }) => PluginObject;

    get(name: "box-whiskers"): (settings?: { mode: "show-scatter" | "hide-scatter" | "outliers-only" }) => PluginObject;

    get(
      name: "category-filter"
    ): (settings?: { fields?: string[]; formatters?: any; skipColorDim?: boolean }) => PluginObject;
    ...
    get(name: "floating-axes"): (settings?: { detectBackground?: boolean; bgcolor?: string }) => PluginObject;
    ...
    get(name: "legend"): (settings?: { position?: "left" | "right" | "top" | "bottom" }) => PluginObject;

    get(name: "quick-filter"): (settings?: { fields?: string[]; applyImmediately?: boolean }) => PluginObject;
