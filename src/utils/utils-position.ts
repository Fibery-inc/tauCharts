import { ClosestElementInfo } from "../definitions";
...
export function getClosestPointInfo(
  ...
  const items = bestMatchItems.sort((a, b) =>
    a.distance === b.distance ? a.secondaryDistance - b.secondaryDistance : a.distance - b.distance
  );
